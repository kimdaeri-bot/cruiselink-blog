---
cruise_id: carib-rci-icon-20261206
title: 동카리브해 7박 아이콘 크루즈
cruiseLine: royal-caribbean
cruiseLineName: 로열캐리비안
ship: 아이콘 오브 더 씨즈
shipTonnage: 250,800톤
shipPassengers: 5,610명
shipYear: '2024'
...
**🎯 추천 기항지 투어**
- **America's Cup 12 Metre Yacht Race** (~$109) — 실제 아메리카스컵 요트를 타고 팀 레이스. 로열캐리비안 세인트마틴 인기 투어 부동의 1위.
- **Rhino Rider & Snorkel Adventure** (~$89) — 2인승 미니 보트로 해안 탐험 후 산호초 스노클링. 직접 보트를 몰며 카리브해를 누비는 체험.
- **Beach, Sightseeing & Shopping Tour** (~$59, 반나절) — 프랑스·네덜란드 양쪽 하이라이트 투어 + 마호 비치 + 면세 쇼핑 시간.

**🚶 자유여행 추천**
- 마호 비치 — 택시 $15/15분. 비행기 착륙 장면 감상 (SXM Airport 앱으로 스케줄 확인)
- 그랑카스(Grand Case) — 프랑스령 미식 거리, 크레올 로로 BBQ 스탠드
- 필립스버그 보드워크 — 면세 쇼핑+해변 산책, 항구에서 도보 이동 가능
...
**🎯 추천 기항지 투어**
- **St. John Island & Trunk Bay Snorkeling** (~$99, 반나절) — 페리로 세인트존 이동, 세계적 스노클링 명소 트렁크 베이에서 수중 트레일 체험.
- **Coral World Ocean Park & Sea Trek** (~$109) — 해저 헬멧 다이빙으로 바닷속을 걸으며 산호초와 열대어 관찰. 수영 못해도 OK.
- **Island Highlights & Magens Bay Beach** (~$69, 반나절) — 마운틴탑 전망대 파노라마 조망 후 세계 10대 해변 매건스 베이에서 해변 자유시간.

**🚶 자유여행 추천**
- 매건스 베이 비치 — 택시 합승 $10/인, 입장료 $5. 하얀 모래+투명한 바다
- 스카이라이드(Paradise Point) — 곤돌라 $25, 700ft 높이 전망대에서 항구 파노라마
- 메인 스트리트 면세 쇼핑 — 보석·시계·주류 면세 (1인 $1,600 한도)
...
**🎯 추천 기항지 투어**
- **Thrill Waterpark Day Pass** (~$80) — 드레드폴(135ft) 포함 13개 워터슬라이드 + 북미 최대 파도풀. 종일 무제한 이용.
- **Up, Up and Away Helium Balloon** (~$40) — 450ft 높이 헬륨 풍선에서 바하마 군도 파노라마. 가족 단위 인기 체험.
- **Overwater Cabana Experience** (~$350~900) — 바다 위 프라이빗 카바나. 전용 슬라이드, 음료 서비스, 스노클링 장비 포함. 사전 예약 필수.

**🚶 자유여행 추천**
- 칠 아일랜드 & 사우스 비치 (무료) — 해먹+파라솔+에메랄드빛 바다로 하루 종일 힐링
- 짚라인 (무료) — 1,600ft 해변 위 짚라인
- 캡틴 잭스 & 스낵 쉑 (무료) — 버거, BBQ, 해산물 무료 식사
